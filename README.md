...
This repository is a complete local pitch/demo environment. Its default authentication settings are for demonstrations only; do not expose them as a production security boundary.
