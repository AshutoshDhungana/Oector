...
export default function TrustCenterPage() {
  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-slate-50"><PublicNav /><div className="flex min-h-[calc(100vh-4rem)] items-center justify-center">
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="mt-10 rounded-lg bg-slate-900 text-white p-6">
          ...
          <div className="text-slate-300 mt-1 text-sm">
            Send us your questionnaire — Oector auto-drafts answers with citations,
